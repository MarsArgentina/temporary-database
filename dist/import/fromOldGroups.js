...
exports.importOldGroups = void 0;
var __1 = require("..");
var importOldGroups = function (event, info) { return __awaiter(void 0, void 0, void 0, function () {
    var result, final;
                                    ...
                                    return [4 /*yield*/, Promise.all(invites.map(function (discord) { return __awaiter(void 0, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        _a.trys.push([0, 3, , 4]);
                                                        return [4 /*yield*/, __1.UserModel.findFromDiscord(discord)];
                                                    case 1:
                                                        user = _a.sent();
                                                        return [4 /*yield*/, (user === null || user === void 0 ? void 0 : user.getInvite(event, false))];
                                                    case 2:
                                                        invite = _a.sent();
                                                        if (invite) {
